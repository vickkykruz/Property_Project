                  ...
                  Padding(
                    ...
                    child: StreamBuilder<List<BookingsRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<BookingsRecord> currentBookingsBookingsRecordList =
                            snapshot.data!;
                        return ListView.builder(
                          ...
                          itemCount: currentBookingsBookingsRecordList.length,
                            ...
                            return Padding(
                              ...
                              child: StreamBuilder<PlacesRecord>(
                                stream: PlacesRecord.getDocument(
                                    currentBookingsBookingsRecord.placeRef!),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                                    return Center(
                    ...
                    child: StreamBuilder<List<BookingsRecord>>(
                      stream: queryBookingsRecord(
                        ...
                        queryBuilder: (bookingsRecord) => bookingsRecord
                            .where('endDate', isLessThan: getCurrentTimestamp),
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        if (!snapshot.hasData) {
                        ...
                        List<BookingsRecord> pastBookingsBookingsRecordList =
                            snapshot.data!;
                        return ListView.builder(
                          padding: EdgeInsets.zero,
                          primary: false,
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    8.0),
                                                        child: Text(
                                                          '${dateTimeFormat('yMMMd', pastBookingsBookingsRecord.startDate)} - ${dateTimeFormat('yMMMd', pastBookingsBookingsRecord.endDate)}',
                                                          textAlign:
                                                              TextAlign.end,
                                                          style: FlutterFlowTheme
                                                                  .of(context)
